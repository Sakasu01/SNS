...
export default function Rightbar({ profile }) { {/*profileというプロップスを受け取っておく*/}
  const HomeRightbar = () => {
    return (
      <>
          ...
          <p className='promotionName'>Sakasu株式会社</p>
        </>
    );
  };
        ...
        <div className="rightbarInfo">
          ...
          <div className="rightbarFollowings">
            <div className="rightbarFollowing">
              <img
                src={"assets/person/1.jpeg"} alt="" className="rightbarFollowingImg"
              />
              <span className="rightbarFollowingName">Sakasu</span>
            </div>
            <div className="rightbarFollowing">
              <img
                src={"assets/person/2.jpeg"} alt="" className="rightbarFollowingImg"
              />
            ...
            <div className="rightbarFollowing">
              <img
                src={"assets/person/5.jpeg"} alt="" className="rightbarFollowingImg"
              />
